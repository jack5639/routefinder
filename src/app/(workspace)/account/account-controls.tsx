  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-[2rem] bg-white p-6 shadow-sm">
        ...
        <button onClick={() => void purchase()} className="mt-5 min-h-12 rounded-full bg-ink px-6 font-black text-white">Buy Cycle — £29 founding launch</button>
        <p className="mt-2 text-xs font-semibold text-ink/50">£29 for the first 50 customers; £59 afterward. The checkout always shows the current price before payment.</p>
      </section>
      <section className="rounded-[2rem] bg-white p-6 shadow-sm">
