    ...
    <main className="min-h-screen bg-[linear-gradient(145deg,#fbf8ef,#eef8f1_46%,#dceeff)] px-4 py-12 text-ink sm:px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          ...
          <section className="rounded-[2rem] bg-mint p-7 shadow-sm"><p className="text-xs font-black uppercase tracking-wide text-leaf">Cycle · founding launch</p><p className="mt-3 text-4xl font-black">£29</p><p className="mt-2 font-semibold text-ink/55">First 50 customers, then £59</p><div className="mt-6"><PurchaseButton /></div></section>
        </div>
